...
In this episode, we will explore how to extract information from phylogenetic trees in order to create hypotheses and draw inferences about biodiversity patterns. The phylogenetic history of species across communities, coupled with information on their spatial distribution and abundance, give several insights about 
and how we can interpret relationships of species in a community. The phylogenic history of species 

Similarly to how species in a community may show different degrees of trait variation, local communities differ in their representation of the tree of life. Depending on different factors such as age and size of the communitu, local environmental conditions
