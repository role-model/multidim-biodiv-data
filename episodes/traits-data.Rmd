...
plot(density(abund_traits_split$hawaiiisland_01$mean_mass_mg), main = "Average mass per study site", 
     xlab = "Average mass (mg)", ylab = "Density", lwd = 2, col = "#440154FF")

lines(density(abund_traits_split$kauai_01$mean_mass_mg), lwd = 2, col = "#31688EFF")
lines(density(abund_traits_split$maui_01$mean_mass_mg), lwd = 2, col = "#35B779FF")
lines(density(abund_traits_split$molokai_01$mean_mass_mg), lwd = 2, col = "#FDE725FF")

legend("topright", legend = c("Hawaii 01", "Kauai 01", "Maui 01", "Molokai 01"), lwd = 2, col = c("#440154FF", "#31688EFF", "#35B779FF", "#FDE725FF"))
```
