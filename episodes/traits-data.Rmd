...
traits_hill0 <- hill_func(comm = abundance_wide, traits = traits_simple, q = 0)

traits_hill1 <- hill_func(comm = abundance_wide, traits = traits_simple, q = 1)

traits_hill2 <- hill_func(comm = abundance_wide, traits = traits_simple, q = 2)
```
...
```{r traits-hill-df}
traits_hill <- list(traits_hill1[3,], traits_hill2[3,])
...
What are some other interpretations from the plots, summary statistics, and what you know from the island histories can you make about this system?
