...
[Hill numbers and effective nb of species content].
...
abundances <- read.csv("https://raw.githubusercontent.com/role-model/multidim-biodiv-data/main/episodes/data/abundance_tallies.csv")
...
```{r separate islands using split, eval =T}
...
```{r site by species matrix via pivot wider}
...
```{r site by species matrix row names}
