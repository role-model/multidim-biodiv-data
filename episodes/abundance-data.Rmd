...
- How is organismal abundance data typically recorded and stored?
- How do I clean and manipulate abundance data to prepare for analyses?
- How do we use summary statistics - including Hill numbers - to compare abundance data across systems?
...
`abundances` is a data frame with columns for `island`, `site`, and `GenSp` (Genus-Species). These data are in a common format in which each row represents a single individual observed. 
