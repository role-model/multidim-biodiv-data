...
hawaii_richness <- length(unique(hawaiiisland_abund$matched_name2))
hawaii_richness
...
maui_richness <- length(unique(maui_abund$matched_name2))
...
kauai_richness <- length(unique(kauai_abund$matched_name2))
