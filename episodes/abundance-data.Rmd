...
wtf <- taxize::gnr_resolve(species_list, best_match_only = TRUE, 
...
# don't need if using `best_match_only = TRUE` in `taxize::gnr_resolve`
...
abundances$final_name[abundances$final_name == "Cirphis"] <- "Cirphis pyrrhias"
